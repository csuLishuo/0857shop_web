  ...
  .detailCoupon-container{
    ...
    .title{
      ...
      .share{
        ...
        background-size: px2rem(26) px2rem(30);
        background-position: px2rem(21) px2rem(10);
      ...
      .line{
        ...
        .right-box{
          ...
          .location{
            ...
            background-repeat: no-repeat;
            background-size: px2rem(21) px2rem(27);
...
<template>
  <div class="detailCoupon-container">
    <div class="tabs">
        ...
        <van-tab title="商品详情">
          ...
          <div class="area-1">
            ...
            <div class="line">
              ...
              <div class="right-box">
                <div class="text-2">正品保证</div>
                <div class="text-2">极速发货</div>
                <div class="text-2">极速退款</div>
                <div class="text-2">七天退换货</div>
              </div>
            </div>
          </div>
          <div class="area-1">
...
export default {
  ...
  methods: {
    ...
    getDetailData () {
      this.$post('/api/goodsCoupon/getGoodsCouponById', {
        id: this.detailId
        // goodsId: 1
      }).then(res => {
        if (res.result === 0) {
