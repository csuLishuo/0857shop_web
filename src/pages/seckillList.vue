        ...
        .right-box{
          ...
          .bar{
            ...
            span{
              ...
              left: 0;
              top: 0;
              background-image: linear-gradient(-90deg, #ff2736 0%, #ff2b71 100%), linear-gradient(#ffcbcb, #ffcbcb);
              background-blend-mode: normal, normal;
            }
          }
          .price-box{
...
<template>
  <div class="seckillList-container">
    <div class="topBar">
    ...
    <div class="area-2">
      <div class="left-text">抢购中 先下单先得哦</div>
      <div class="right-box">
