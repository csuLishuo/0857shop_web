...
<template>
  <div class="receiveCode-container">
    <div class="topBar">
      <div class="left-box" @click="goBack"><img src="../images/icon39.png" alt=""></div>
      <div class="title">收货码</div>
    </div>
    <van-tabs v-model="active">
      <van-tab title="全部"></van-tab>
      <van-tab title="未扫码收货"></van-tab>
      <van-tab title="已扫码收货"></van-tab>
    </van-tabs>
    <div class="listbox">
      <div class="wrapper">
